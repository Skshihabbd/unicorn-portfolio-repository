    ...
    <section>
        <div class=" flex justify-between items-center my-16 ">
            ...
            <div class="space-y-2">
                ...
                <p><span class="font-bold">Network Infrastructure Design & Implementation</span> – Setting up and optimizing LAN, WAN, and
                    cloud-based networks</p>
                <p><span class="font-bold">Cloud Networking</span> – Integrating cloud solutions like AWS, Azure, and Google Cloud for
                    scalable networking</p>
                <p><span>Cybersecurity & Network Protection</span> – Implementing firewalls, intrusion detection systems
                    (IDS), and VPN security.</p>
                <p><span class="font-bold">IoT Network Integration</span> – Connecting smart devices and IoT ecosystems for real-time data
                    exchange.</p>

                <p><span class="font-bold">Managed Network Services</span> – 24/7 monitoring, maintenance, and support for business
                    networks.</p>
