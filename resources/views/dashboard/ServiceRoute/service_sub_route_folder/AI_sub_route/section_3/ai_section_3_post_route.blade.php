...
<section>
    <div class=" main-div">
        <div class="form-div">
            <form id="ai_section_3_post" method="POST" action="" enctype="multipart/form-data">
                @csrf
        ...
        <div class="dynamic-div">
            ...
            <div style="width: 60% ;margin-left:auto; margin-right:auto" class="card" style="width: 100%;">
                ...
                <div class="card-body" style=" display:flex; justify-content:space-between ; font-size:25px;">
                    <a class="btn btn-secondary" style="text-decoration:none;" href="{{route('ai_section_3_single_data',['id'=>$allData->id])}}"
                        class="card-link">Update</a>

                        <form method="POST" action="{{route('ai_section_3_delete_data',['id'=>$allData->id])}}">
                            @csrf
                            @method('DELETE')
...
@section('script')
<script src="{{asset('asset/script_file/servicemain_folder_js_file/service_subfolder_js_file/Ai_folder_js_file/section_3_js_file/section_3ai_post.js')}}"></script>
@endsection
