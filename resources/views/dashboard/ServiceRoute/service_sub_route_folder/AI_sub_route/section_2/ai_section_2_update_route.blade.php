...
@section('dashboard')
    <div style="width: 100%;" class="form-div">
        <form id="ai_section_2_update" method="POST" action="" enctype="multipart/form-data">
            @csrf
...
@section('script')
<script src="{{asset('asset/script_file/servicemain_folder_js_file/service_subfolder_js_file/Ai_folder_js_file/section_2_js_file/section_2ai_update.js')}}"></script>
@endsection
