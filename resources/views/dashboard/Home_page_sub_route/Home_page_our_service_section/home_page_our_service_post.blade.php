...
@section('dashboard')
    <section>
        <div class=" main-div">
            <div class="form-div">
                <form id="home_ourservice_post" method="POST" action="" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="dynamic-div">
              ...
              <div style="width: 60% ;margin-left:auto; margin-right:auto" class="card" style="width: 100%;">
                ...
                <div class="card-body" style=" display:flex; justify-content:space-between ; font-size:25px;">
                    <a class="btn btn-secondary" style="text-decoration:none;" href="{{route('home_ourservice_single_data',['id'=>$allData->id])}}"
                    class="card-link">Update</a>
                    <form method="POST" action="{{route('home_ourservice_delete_data',['id'=>$allData->id])}}">
                        @csrf
                        @method('DELETE')
...
@section('script')
    <script
        src="{{ asset('asset/script_file/Home-section-js-file/our-service-section/Home_our_service_section_post.js') }}">
    </script>
@endsection
