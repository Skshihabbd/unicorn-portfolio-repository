...
@section('dashboard')
    <div style="width: 100%;" class="form-div">
        <form id="home_analysis_update" method="POST" action="" enctype="multipart/form-data">
            @csrf
...
@section('script')
<script src="{{asset('asset/script_file/Home-section-js-file/analysis-section/Home_analysis_update.js')}}"></script>
@endsection
