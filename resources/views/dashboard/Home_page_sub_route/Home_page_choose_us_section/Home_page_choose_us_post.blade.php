...
@section('dashboard')
    <section>
        <div class=" main-div">
            <div class="form-div">
                <form id="home_choose_us_post" method="POST" action="" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="dynamic-div">
              ...
              <div style="width: 60% ;margin-left:auto; margin-right:auto" class="card" style="width: 100%;">
                ...
                <div class="card-body" style=" display:flex; justify-content:space-between ; font-size:25px;">
                    <a class="btn btn-secondary" style="text-decoration:none;" href="{{route('home_choose_us_single_data',['id'=>$allData->id])}}"
                    class="card-link">Update</a>
                    <form method="POST" action="{{route('home_choose_us_delete_data',['id'=>$allData->id])}}">
                        @csrf
                        @method('DELETE')
...
@section('script')
    <script
        src="{{ asset('asset/script_file/Home-section-js-file/home-section-choose-us/home_section_choose_us_post.js') }}">
    </script>
@endsection
