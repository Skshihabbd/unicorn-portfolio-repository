...
@section('dashboard')
    <div style="width: 100%;" class="form-div">
        <form id="home_choose_us_update" method="POST" action="" enctype="multipart/form-data">
            @csrf
...
@section('script')
<script src="{{asset('asset/script_file/Home-section-js-file/home-section-choose-us/home_section_choose_us_update.js')}}"></script>
@endsection
