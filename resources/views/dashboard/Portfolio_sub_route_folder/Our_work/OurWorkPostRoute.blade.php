            ...
            <div class="form-div">
                <form id="ourwork" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div> <label class="" for="heading">Heading</label> <br>
                        <input id="heading" type="text"  placeholder="Input heading" name="heading"
                            class="form-control" /> <br>
                   ...
                   <textarea  name="description"  class="form-control"   id="" cols="30" rows="10"></textarea> <br>
                   <small class="error-message" style="color:red; " id="error-description"></small>
                    ...
                    <div>
                        ...
                        <textarea class="form-control" id="explaination"  name="area" style=" height:30vh;">      Input Explaination
                  </textarea> <br>
