    ...
    <div class="bg-[#0B4392]">
        ...
        <div class=" w-11/12 mx-auto pt-6 pb-36 flex justify-between gap-10">
            <div class="w-6/12 space-y-6">
                @forelse ($service_category_all_datas_get as $service_category_all_data_get)
        ...
        @empty
            ...
            <button class="bg-[#119EB6] w-full rounded-2xl py-5 grid grid-cols-3 focus:bg-white focus:text-black"><span
        ...
        <div class=" w-full ">
            ...
            <div>
                ...
                <img id="image" class="h-[80vh] rounded-xl w-10/12"
                    src="{{ asset('asset/pexels-souvenirpixels-414612.jpg') }}" alt="" srcset="">

                <p id="title" class="text-5xl text-white my-3">web design</p>
                <p id="description" class="text-white text-xl">taking useful information out of your data and putting it
                    in
                    a visual
    ...
    <div class="bg-[#0B4392] pt-24">
        ...
        <div class="py-16 w-11/12 mx-auto flex justify-between">
            <button onclick="tabBar('tab-1')"
                class="text-white border-[1px] border-white py-4 md:px-12 lg:px-20 rounded-full focus:bg-[#1AA7BA] ">Design
            </button>
            <button onclick="tabBar('tab-2')"
                class="text-white border-[1px] border-white py-4 md:px-12 lg:px-20 rounded-full focus:bg-[#1AA7BA] ">Fronend
            </button>
            <button onclick="tabBar('tab-3')"
                class="  text-white border-[1px] border-white py-4 md:px-12 lg:px-20 rounded-full focus:bg-[#1AA7BA] ">Backend
            </button>
            <button onclick="tabBar('tab-4')"
                class="text-white border-[1px] border-white py-4 md:px-12 lg:px-20 rounded-full focus:bg-[#1AA7BA] ">Database
            </button>
        </div>
        {{-- text-stack-icon div --}}
